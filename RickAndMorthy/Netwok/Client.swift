...
struct Client{
    ...
    func get(_ path: String, queryParams: [String:String], success: requestHandler?, failure: errorHandler? = nil){
        request(method: "GET", path: path,queryParams: queryParams, body: nil, success: success, failure: failure)
    }
    
    func request(method: String, path: String, queryParams: [String:String], body: Data?, success: requestHandler?, failure: errorHandler? = nil){
        guard let request = buildRequees(method: method, path: path, queryParams: queryParams, body: body) else{
    ...
    private func buildRequees(method: String, path: String, queryParams: [String:String], body: Data?) -> URLRequest?{
